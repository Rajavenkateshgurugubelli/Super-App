...
import Button from './Button'; // Local vendored copy of shared-ui Button
            ...
            <div className="flex justify-between items-center mb-6">
                <div>
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <Button onClick={refreshBalance} variant="secondary" className="px-2 py-1 text-xs">Refresh</Button>
                    </div>
                </div>
