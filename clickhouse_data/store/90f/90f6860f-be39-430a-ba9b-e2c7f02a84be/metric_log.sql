ATTACH TABLE _ UUID '3778fa78-140d-4a1a-a68b-b67f25bb312d'
(
    ...
    `ProfileEvent_ASTFuzzerQueries` UInt64 COMMENT 'Number of fuzzed queries attempted by the server-side AST fuzzer.',
    ...
    `ProfileEvent_QuorumParts` UInt64 COMMENT 'Number of data parts written with quorum. It counts as one part for sync insert and maybe up to async inserts count for insert which flushes async inserts.',
    `ProfileEvent_QuorumWaitMicroseconds` UInt64 COMMENT 'Total time spent waiting for quorum during inserts.',
    `ProfileEvent_QuorumFailedInserts` UInt64 COMMENT 'Number of inserts failed due to quorum not reaching.',
    ...
    `ProfileEvent_DuplicatedInsertedBlocks` UInt64 COMMENT 'Number of the synchronous inserts to a *MergeTree table was deduplicated.',
    ...
    `ProfileEvent_DeltaLakeSnapshotInitializations` UInt64 COMMENT 'Number of times a DeltaLake table snapshot was initialized (loaded from object storage)',
    `ProfileEvent_DeltaLakeScannedFiles` UInt64 COMMENT 'Number of files scanned during DeltaLake scan callbacks',
    ...
    `ProfileEvent_IndexAnalysisRounds` UInt64 COMMENT 'Number of times index analysis was performed within the query.',
    ...
    `ProfileEvent_DistributedIndexAnalysisReplicaUnavailable` UInt64 COMMENT 'Number of times distributed index analysis failed on one of replicas without fallback (failed during connect)',
    `ProfileEvent_DistributedIndexAnalysisReplicaFallback` UInt64 COMMENT 'Number of times distributed index analysis failed on one of replicas with fallback to local replica',
    ...
    `ProfileEvent_MergeWrittenRows` UInt64 COMMENT 'Number of rows written during the merge.',
    ...
    `ProfileEvent_FilesystemCacheCheckCorrectnessMicroseconds` UInt64 COMMENT 'How much time does FileCache::assertCacheCorrectness takes',
    ...
    `ProfileEvent_MetadataFromKeeperCacheTooManyInvalidated` UInt64 COMMENT 'Number of times filesystem cache returned too many invalidated entries',
    ...
    `ProfileEvent_MetadataFromKeeperBackgroundCleanupBlobs` UInt64 COMMENT 'Number of times an empty blob layout part was cleaned up by background task',
    ...
    `ProfileEvent_BlobKillerThreadRuns` UInt64 COMMENT 'Number of BlobKiller thread executes',
    `ProfileEvent_BlobKillerThreadLockedBlobs` UInt64 COMMENT 'Number of blobs returned from metadata storage',
    `ProfileEvent_BlobKillerThreadRemoveTasks` UInt64 COMMENT 'Number of remove tasks created by BlobKiller',
    `ProfileEvent_BlobKillerThreadRemovedBlobs` UInt64 COMMENT 'Number of blobs removed by BlobKiller',
    `ProfileEvent_BlobKillerThreadRecordedBlobs` UInt64 COMMENT 'Number of blobs which removal by BlobKiller was recorded in metadata storage',
    `ProfileEvent_BlobKillerThreadLockBlobsErrors` UInt64 COMMENT 'Number of blobs lock errors occurred during BlobKiller execution',
    `ProfileEvent_BlobKillerThreadRemoveBlobsErrors` UInt64 COMMENT 'Number of blobs removal errors occurred during BlobKiller execution',
    `ProfileEvent_BlobKillerThreadRecordBlobsErrors` UInt64 COMMENT 'Number of blobs recording errors occurred during BlobKiller execution',
    `ProfileEvent_BlobCopierThreadRuns` UInt64 COMMENT 'Number of BlobCopier thread executes',
    `ProfileEvent_BlobCopierThreadLockedBlobs` UInt64 COMMENT 'Number of blobs returned from metadata storage',
    `ProfileEvent_BlobCopierThreadReplicatedBlobs` UInt64 COMMENT 'Number of blobs replicated by BlobCopier',
    `ProfileEvent_BlobCopierThreadRecordedBlobs` UInt64 COMMENT 'Number of blobs which replication by BlobCopier was recorded in metadata storage',
    `ProfileEvent_BlobCopierThreadLockBlobsErrors` UInt64 COMMENT 'Number of blobs lock errors occurred during BlobCopier execution',
    `ProfileEvent_BlobCopierThreadReplicateBlobsErrors` UInt64 COMMENT 'Number of blobs replication errors occurred during BlobCopier execution',
    `ProfileEvent_BlobCopierThreadRecordBlobsErrors` UInt64 COMMENT 'Number of blobs recording errors occurred during BlobCopier execution',
    ...
    `ProfileEvent_KeeperRequestTotalWithSubrequests` UInt64 COMMENT 'Total requests number on keeper server, counting each subrequest within a multi request',
    ...
    `ProfileEvent_SharedMergeTreeCondemnedPartsLockConflict` UInt64 COMMENT 'How many times we failed to acquite lock because of conflict',
    ...
    `ProfileEvent_SharedMergeTreeSnapshotPartsCleanRequest` UInt64 COMMENT 'How many times SnapshotCleanerThread decides to clean a part',
    `ProfileEvent_SharedMergeTreeSnapshotPartsCleanerParts` UInt64 COMMENT 'How long time SnapshotCleanerThread tries to clean a part',
    `ProfileEvent_SharedMergeTreeSnapshotPartsRemoved` UInt64 COMMENT 'How many times SnapshotCleanerThread successfully clean a part',
    `ProfileEvent_SharedMergeTreeSnapshotPartsCleanerRuns` UInt64 COMMENT 'How many times SnapshotCleanerThread runs',
    `ProfileEvent_SharedMergeTreeSnapshotPartsCleanerMicroseconds` UInt64 COMMENT 'How long time SnapshotCleanerThread has run',
    `ProfileEvent_SharedMergeTreeSnapshotPartsCleanerPartsMicroseconds` UInt64 COMMENT 'How long time SnapshotCleanerThread takes to clean parts',
    ...
    `ProfileEvent_ParquetRowsFilterExpression` UInt64 COMMENT 'The total number of rows that were passed through filter',
    `ProfileEvent_ParquetColumnsFilterExpression` UInt64 COMMENT 'The total number of columns that were passed through filter',
    ...
    `CurrentMetric_ASTFuzzerAccumulatedFragments` Int64 COMMENT 'Number of AST fragments accumulated by the server-side AST fuzzer for use in future mutations.',
    `CurrentMetric_QueryNonInternal` Int64 COMMENT 'Number of executing non-internal queries (queries initiated by users, excluding internal queries from ClickHouse)',
    ...
    `CurrentMetric_DeltaLakeSnapshotCacheSizeElements` Int64 COMMENT 'Size in elements of DeltaLake snapshot cache.',
    ...
    `CurrentMetric_SharedMergeTreeMaxActiveReplicas` Int64 COMMENT 'The maximum number of active replicas registered in Keeper',
    `CurrentMetric_SharedMergeTreeMaxInactiveReplicas` Int64 COMMENT 'The maximum number of inactive replicas registered in Keeper',
    `CurrentMetric_SharedMergeTreeMaxReplicas` Int64 COMMENT 'The maximum number of replicas registered in Keeper across all tables. Note it might not be a sum of SharedMergeTreeMaxActiveReplicas and SharedMergeTreeMaxInactiveReplicas',
    `CurrentMetric_SharedMergeTreeMinActiveReplicas` Int64 COMMENT 'The minimum number of active replicas registered in Keeper',
    `CurrentMetric_SharedMergeTreeMinInactiveReplicas` Int64 COMMENT 'The minimum number of inactive replicas registered in Keeper',
    `CurrentMetric_SharedMergeTreeMinReplicas` Int64 COMMENT 'The minimum number of replicas registered in Keeper across all tables. Note it might not be a sum of SharedMergeTreeMinActiveReplicas and SharedMergeTreeMinInactiveReplicas',
    `CurrentMetric_SharedMergeTreeMinPartitions` Int64 COMMENT 'The minimum number of partitions registered in Keeper across all SharedMergeTree tables',
    `CurrentMetric_SharedMergeTreeMaxPartitions` Int64 COMMENT 'The maximum number of partitions registered in Keeper across all SharedMergeTree tables',
    ...
    `CurrentMetric_BlobKillerThreads` Int64 COMMENT 'Number of threads in the thread pool of the object storage disk background removal process',
    `CurrentMetric_BlobKillerThreadsActive` Int64 COMMENT 'Number of threads in the thread pool of the object storage disk background removal process running a task',
    `CurrentMetric_BlobKillerThreadsScheduled` Int64 COMMENT 'Number of queued or active tasks in the thread pool of the object storage disk background removal process',
    `CurrentMetric_BlobCopierThreads` Int64 COMMENT 'Number of threads in the thread pool of the object storage disk background replication process',
    `CurrentMetric_BlobCopierThreadsActive` Int64 COMMENT 'Number of threads in the thread pool of the object storage disk background replication process running a task',
    `CurrentMetric_BlobCopierThreadsScheduled` Int64 COMMENT 'Number of queued or active tasks in the thread pool of the object storage disk background replication process',
